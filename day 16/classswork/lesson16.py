# 1)მომხმარებელს შემოატანინეთ მისი სახელი, შემდეგ კი შეეკითხეთ როგორ უნდა სახელის შეცვლა (lower/upper/capitalize) თუ შემოიტანს upper, მაშინ დაუბეჭდეთ სახელი გადიდებულად, თუ შემოიტანს lower, მაშინ დაუბეჭდეთ სახელი დაპატარავებულად და თუ შემოიტანს capitalize, მაშინ სახელის პირველი ასო გაუდიდეთ.
